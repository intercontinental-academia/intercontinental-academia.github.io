...
pinned: false
post_title:
  'Day 5: "an Argus with billions of eyes and ears, capacity for action,
  and infinite memory!"'
...
Later on, [**Professor Shimon Ullman**](https://www.intercontinental-academia.com/mentors#ullman 'Shimon Ullman') argued that with the amazing rate of advances in AI, anticipating correctly what will happen on a time scale of decades is an impossible task, and potentially embarrassing in retrospect.
